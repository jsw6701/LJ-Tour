...
<style>
    ...
    .pic1 {
        background-image: url(pic/GrHotel2.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/grhotel2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/grhotel2-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 더블">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel2-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 더블">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel2-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 더블">
        </div>
    </div><br>
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/grhotel2-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel2-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel2-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel2-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
...
$sql = "select * from hotel where name like 'Courtyard by Marriott Cologne%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
