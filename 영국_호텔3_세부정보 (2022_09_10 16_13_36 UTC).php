...
<style>
    ...
    .pic1 {
      background-image: url(pic/EnHotel3.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/enhotel3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/enhotel3-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 더블">
        </div>

        <div class="w3-col m3">
          <img src="pic/enhotel3-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 싱글">
        </div>

        <div class="w3-col m3">
          <img src="pic/enhotel3-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/enhotel3-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel3-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="복도">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel3-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="프론트">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel3-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="입구">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like 'The Fielding Hotel%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
