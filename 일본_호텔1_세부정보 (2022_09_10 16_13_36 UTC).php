...
<style>
    ...
    .pic1 {
      background-image: url(pic/jpHotel1.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/jphotel1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/jphotel1-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="테니스장">
        </div>

        <div class="w3-col m3">
          <img src="pic/jphotel1-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="레스토랑">
        </div>

        <div class="w3-col m3">
          <img src="pic/jphotel1-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/jphotel1-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="레스토랑">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel1-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스카이 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel1-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스카이 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel1-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스카이 트윈">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like '시나가와 프린스 호텔%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
