...
<style>
    ...
    .pic1 {
      background-image: url(pic/EnHotel4.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/enHotel4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/enhotel4-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>

        <div class="w3-col m3">
          <img src="pic/enhotel4-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 더블">
        </div>

        <div class="w3-col m3">
          <img src="pic/enhotel4-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 더블">
        </div>
    </div><br>
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/enhotel4-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="뷔페">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel4-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="와인 바">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel4-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/enhotel4-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like 'The Queens Gate Hotel%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
