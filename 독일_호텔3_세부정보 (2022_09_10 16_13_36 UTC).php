...
<style>
    ...
    .pic1 {
      background-image: url(pic/GrHotel3.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/grhotel3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정면">
        </div>

        <div class="w3-col m3">
            <img src="pic/grhotel3-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel3-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel3-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>
    </div><br>
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/grhotel3-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="패밀리룸">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel3-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel3-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel3-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="야외 발코니">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like 'Nelim de conde%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
