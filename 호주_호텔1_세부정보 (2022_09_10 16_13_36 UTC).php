...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/oshotel1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/oshotel1-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="테니스장">
        </div>

        <div class="w3-col m3">
          <img src="pic/oshotel1-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="레스토랑">
        </div>

        <div class="w3-col m3">
          <img src="pic/oshotel1-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="야외수영장">
        </div>
    </div><br>

    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/oshotel1-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="호텔 내부 BAR">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel1-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel1-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel1-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>
  </div>
</div>
<div id="HotelIntro" class="w3-container w3-content w3-padding-32"><br>
  <h2 class="w3-left">Hillton Brizbon 의 세부정보</h2><br><br>
  <h4>■ 호텔 이용 규칙<br>
...
$sql = "select * from hotel where name like 'Hillton Brizbon%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
