...
<html>
    ...
    <div class="main2 main-Sh">
        ...
        <div class="button1"><a href="한국_호텔1_세부정보.php?name=<?=$row['name']?>&price=<?=$row['price']?>&photo=<?=$row['photo']?>&location=<?=$row['location']?>">객실확인</a></div>
    </div>                      
    <?php       }
            }
        }
    ...
    <div class="main2 main-Sh">
        ...
        <div class="button1"><a href="한국_호텔2_세부정보.php?name=<?=$row['name']?>&price=<?=$row['price']?>&photo=<?=$row['photo']?>&location=<?=$row['location']?>">객실확인</a></div>
    </div>                      
    <?php       }
            }
        }
    ...
    <div class="main2 main-Sh">
        ...
        <div class="button1"><a href="한국_호텔3_세부정보.php?name=<?=$row['name']?>&price=<?=$row['price']?>&photo=<?=$row['photo']?>&location=<?=$row['location']?>">객실확인</a></div>
    </div>                  
    <?php       }
            }
        }
    ...
    <div class="main2 main-Sh">
        ...
        <div class="button1"><a href="한국_호텔4_세부정보.php?name=<?=$row['name']?>&price=<?=$row['price']?>&photo=<?=$row['photo']?>&location=<?=$row['location']?>">객실확인</a></div>
    </div>                      
    <?php       }
            }
        }
    ...
    <a href="액티비티.php">
    <div id="floatdiv">한국의 액티비티!<br><br><img src="pic/avy2.jpg" alt="Activity" width="200" height="150"></div>
    </a>
