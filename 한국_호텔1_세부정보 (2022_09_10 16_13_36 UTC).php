...
<style>
    ...
    .pic1 {
      background-image: url(pic/krHotel1.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/krhotel1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/krhotel1-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel1-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 트윈">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel1-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/krhotel1-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트리플">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel1-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="식당">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel1-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="야외수영장">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel1-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
...
$sql = "select * from hotel where name like '제주신화월드 호텔앤리조트%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
