...
<style>
    ...
    .pic1 {
      background-image: url(pic/EnHotel1.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/EnHotel1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="외부">
        </div>

        <div class="w3-col m3">
            <img src="pic/EnHotel1-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="스탠다드 싱글">
        </div>

        <div class="w3-col m3">
          <img src="pic/EnHotel1-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="발코니">
        </div>

        <div class="w3-col m3">
          <img src="pic/EnHotel1-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/EnHotel1-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/EnHotel1-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/EnHotel1-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/EnHotel1-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="패밀리">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like 'Park plaz zeston Hotel%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
