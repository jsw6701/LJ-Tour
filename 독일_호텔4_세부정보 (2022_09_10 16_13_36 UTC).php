...
<style>
    ...
    .pic1 {
      background-image: url(pic/GrHotel4.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/GrHotel4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="외부">
        </div>

        <div class="w3-col m3">
            <img src="pic/grhotel4-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="플로어 더블">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel4-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="식당">
        </div>

        <div class="w3-col m3">
          <img src="pic/grhotel4-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="로비">
        </div>
    </div><br>

    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/grhotel4-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel4-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 싱글">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel4-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="플로어 패밀리">
      </div>

      <div class="w3-col m3">
        <img src="pic/grhotel4-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
...
$sql = "select * from hotel where name like 'Castle ni colambo%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
