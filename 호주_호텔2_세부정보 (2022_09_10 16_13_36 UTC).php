...
<style>
    ...
    .pic1 {
      background-image: url(pic/osHotel2.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/oshotel2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/oshotel2-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="피트니스 센터">
        </div>

        <div class="w3-col m3">
          <img src="pic/oshotel2-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="루프탑 발코니">
        </div>

        <div class="w3-col m3">
          <img src="pic/oshotel2-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/oshotel2-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel2-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel2-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="럭셔리 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/oshotel2-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="객실 내 거실">
      </div>
  </div>
</div>
<div id="HotelIntro" class="w3-container w3-content w3-padding-32"><br>
  <h2 class="w3-left">Meriton Suites 의 세부정보</h2><br><br>
  <h4>■ 호텔 이용 규칙<br>
...
$sql = "select * from hotel where name like 'Meriton Suites%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
