...
<style>
    ...
    .pic1 {
      background-image: url(pic/krHotel4.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/krhotel4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/krhotel4-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="실내수영장">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel4-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="야외 테라스">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel4-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="루프탑 수영장">
        </div>
    </div><br>

    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/krhotel4-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="뷔페">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel4-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel4-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel4-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트리플">
      </div>
  </div>
</div>
<div id="HotelIntro" class="w3-container w3-content w3-padding-32"><br>
  <h2 class="w3-left"><?=$name?> 의 세부정보</h2><br><br>
  <h4>■ 호텔 이용 규칙<br>
...
$sql = "select * from hotel where name like '노보텔 앰배서더 서울 동대문 호텔 & 레지던스%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
