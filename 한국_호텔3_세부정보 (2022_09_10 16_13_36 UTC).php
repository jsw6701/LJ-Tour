...
<style>
    ...
    .pic1 {
      background-image: url(pic/krHotel3.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/krhotel3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/krhotel3-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="식당">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel3-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="로비">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel3-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/krhotel3-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트리플">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel3-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel3-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트리플">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel3-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
...
$sql = "select * from hotel where name like '라마다 군산호텔%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
