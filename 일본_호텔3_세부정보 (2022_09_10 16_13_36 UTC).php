...
<style>
    ...
    .pic1 {
      background-image: url(pic/jpHotel3.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/jphotel3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/jphotel3-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="호텔 내부 BAR">
        </div>

        <div class="w3-col m3">
          <img src="pic/jphotel3-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스파">
        </div>

        <div class="w3-col m3">
          <img src="pic/jphotel3-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="레스토랑">
        </div>
    </div><br>

    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/jphotel3-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="실내수영장">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel3-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스위트 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel3-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스카이 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/jphotel3-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스카이 싱글">
      </div>
  </div>
</div>
<div id="HotelIntro" class="w3-container w3-content w3-padding-32"><br>
  <h2 class="w3-left"><?=$name?>  호텔 의 세부정보</h2><br><br>
  <h4>■ 호텔 이용 규칙<br>
...
$sql = "select * from hotel where name like '안다즈 도쿄 토라노몬 힐스%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
