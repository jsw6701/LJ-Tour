...
<style>
    ...
    .pic1 {
      background-image: url(pic/krHotel2.jpg);
...
<div id="Hotelpic" class="w3-center w3-container w3-padding-0">
    ...
    <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="pic/krhotel2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="정문">
        </div>

        <div class="w3-col m3">
            <img src="pic/krhotel2-2.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
            class="w3-hover-opacity" alt="레스토랑">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel2-3.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
          class="w3-hover-opacity" alt="스탠다드 트리플">
        </div>

        <div class="w3-col m3">
          <img src="pic/krhotel2-1.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
    ...
    <div class="w3-row-padding w3-center">
      <div class="w3-col m3">
        <img src="pic/krhotel2-4.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 더블">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel2-5.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 트윈">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel2-6.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 패밀리">
      </div>

      <div class="w3-col m3">
        <img src="pic/krhotel2-7.jpg" style="width: 471px; height: 265px" onclick="onClick(this)" 
        class="w3-hover-opacity" alt="스탠다드 패밀리">
      </div>
  </div>
</div>
...
$sql = "select * from hotel where name like '웨스턴라이프 호텔%'";
$result = $conn->query($sql);
if($result->num_rows > 0){
